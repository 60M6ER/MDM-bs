<template>
  <q-card flat bordered class="fit column device-details-card">
    <!-- header -->
    <q-card-section class="row items-center">
      ...
      <q-badge
        ...
        :color="details.online ? 'positive' : 'negative'"
        :label="details.online ? 'Онлайн' : 'Оффлайн'"
      />
      <q-space />
    ...
    <q-card-section class="col scroll q-pa-md device-details-card__body">
